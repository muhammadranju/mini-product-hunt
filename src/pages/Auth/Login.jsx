...
const Login = () => {
  return (
    <div className="flex w-full max-w-md my-20 mt-36 mx-auto overflow-hidden rounded-lg shadow-lg lg:max-w-5xl">
      <div
      ...
      <div className="w-full px-6 py-8 md:px-8 lg:w-1/2">
        ...
        <a
          href="#"
          className="flex items-center justify-center mt-4 text-slate-600 transition-colors duration-300 transform border rounded-lg dark:border-slate-700 dark:text-slate-200 hover:bg-slate-50 dark:hover:bg-slate-600"
        >
